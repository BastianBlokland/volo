...
bind_internal(8) in flat f32 in_aspectRatio;    // Aspect ratio of the atom.
bind_internal(9) in flat f32 in_cornerFrac;     // Corner size in fractions of the atom width.
