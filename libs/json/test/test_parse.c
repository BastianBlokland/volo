      ...
      JsonVal expected;
        ...
        {string_lit("{\"a\":true}"),
         (tmpValA = json_add_object(doc),
          json_add_field(doc, tmpValA, string_lit("a"), json_add_bool(doc, true)),
          tmpValA)},
        {string_lit("{\"a\":true,}"),
         (tmpValB = json_add_object(doc),
          json_add_field(doc, tmpValB, string_lit("a"), json_add_bool(doc, true)),
          tmpValB)},
        {string_lit("{\n\"a\"\n:\ntrue\n}"),
         (tmpValC = json_add_object(doc),
          json_add_field(doc, tmpValC, string_lit("a"), json_add_bool(doc, true)),
          tmpValC)},
        {string_lit("{\"a\":1,\"b\":2,\"c\":3}"),
         (tmpValD = json_add_object(doc),
          json_add_field(doc, tmpValD, string_lit("a"), json_add_number(doc, 1.0)),
          json_add_field(doc, tmpValD, string_lit("b"), json_add_number(doc, 2.0)),
          json_add_field(doc, tmpValD, string_lit("c"), json_add_number(doc, 3.0)),
          tmpValD)},
        {string_lit("{\"a\":{},\"b\":{}}"),
         (tmpValE = json_add_object(doc),
          json_add_field(doc, tmpValE, string_lit("a"), json_add_object(doc)),
          json_add_field(doc, tmpValE, string_lit("b"), json_add_object(doc)),
          tmpValE)},
    };
