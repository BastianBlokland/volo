...
static const String g_devGraphics[DevShapeType_Count] = {
    shape_graphic(BoxFill,                    "graphics/dev/shape_box_fill.graphic"),
    shape_graphic(BoxWire,                    "graphics/dev/shape_box_wire.graphic"),
    shape_graphic(BoxOverlay,                 "graphics/dev/shape_box_overlay.graphic"),
    shape_graphic(QuadFill,                   "graphics/dev/shape_quad_fill.graphic"),
    shape_graphic(QuadWire,                   "graphics/dev/shape_quad_wire.graphic"),
    shape_graphic(QuadOverlay,                "graphics/dev/shape_quad_overlay.graphic"),
    shape_graphic(SphereFill,                 "graphics/dev/shape_sphere_fill.graphic"),
    shape_graphic(SphereWire,                 "graphics/dev/shape_sphere_wire.graphic"),
    shape_graphic(SphereOverlay,              "graphics/dev/shape_sphere_overlay.graphic"),
    shape_graphic(HemisphereUncappedFill,     "graphics/dev/shape_hemisphere_uncapped_fill.graphic"),
    shape_graphic(HemisphereUncappedWire,     "graphics/dev/shape_hemisphere_uncapped_wire.graphic"),
    shape_graphic(HemisphereUncappedOverlay,  "graphics/dev/shape_hemisphere_uncapped_overlay.graphic"),
    shape_graphic(CylinderFill,               "graphics/dev/shape_cylinder_fill.graphic"),
    shape_graphic(CylinderWire,               "graphics/dev/shape_cylinder_wire.graphic"),
    shape_graphic(CylinderOverlay,            "graphics/dev/shape_cylinder_overlay.graphic"),
    shape_graphic(CylinderUncappedFill,       "graphics/dev/shape_cylinder_uncapped_fill.graphic"),
    shape_graphic(CylinderUncappedWire,       "graphics/dev/shape_cylinder_uncapped_wire.graphic"),
    shape_graphic(CylinderUncappedOverlay,    "graphics/dev/shape_cylinder_uncapped_overlay.graphic"),
    shape_graphic(ConeFill,                   "graphics/dev/shape_cone_fill.graphic"),
    shape_graphic(ConeWire,                   "graphics/dev/shape_cone_wire.graphic"),
    shape_graphic(ConeOverlay,                "graphics/dev/shape_cone_overlay.graphic"),
    shape_graphic(LineOverlay,                "graphics/dev/shape_line_overlay.graphic"),
};
