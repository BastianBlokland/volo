  ...
  it("can evaluate expressions") {
    const struct {
      ...
      ScriptVal expected;
        ...
        {string_static("type(1)"), script_str(string_hash_lit("number"))},
        {string_static("type(true)"), script_str(string_hash_lit("bool"))},
        {string_static("type(vector(1,2,3))"), script_str(string_hash_lit("vector3"))},
        {string_static("type(\"Hello\")"), script_str(string_hash_lit("string"))},

        // Conversions.
        {string_static("vector(1,2,3)"), script_vec3_lit(1, 2, 3)},
        {string_static("vector(1,true,3)"), script_null()},
        {string_static("vector(1 + 2, 2 + 3, 3 + 4)"), script_vec3_lit(3, 5, 7)},
        {string_static("vector_x(vector(1, 2, 3))"), script_num(1)},
        {string_static("vector_y(vector(1, 2, 3))"), script_num(2)},
        {string_static("vector_z(vector(1, 2, 3))"), script_num(3)},
        ...
        {string_static("distance(vector(0,2,0))"), script_num(2)},
        {string_static("distance(vector(1,2,3), vector(1,3,3))"), script_num(1)},
