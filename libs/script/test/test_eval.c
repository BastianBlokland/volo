  ...
  it("can evaluate expressions") {
    const struct {
      ...
      ScriptVal expected;
        ...
        {string_static("type(vec(1,2,3))"), script_str(string_hash_lit("vec3"))},
        {string_static("type(\"Hello\")"), script_str(string_hash_lit("str"))},

        // Conversions.
        {string_static("vec(1,2,3)"), script_vec3_lit(1, 2, 3)},
        {string_static("vec(1,true,3)"), script_null()},
        {string_static("vec(1 + 2, 2 + 3, 3 + 4)"), script_vec3_lit(3, 5, 7)},
        {string_static("vec_x(vec(1, 2, 3))"), script_num(1)},
        {string_static("vec_y(vec(1, 2, 3))"), script_num(2)},
        {string_static("vec_z(vec(1, 2, 3))"), script_num(3)},
        {string_static("vec_x(vec(1, true, 3))"), script_null()},
        {string_static("vec_y(vec(1, true, 3))"), script_null()},
        {string_static("vec_z(vec(1, true, 3))"), script_null()},
        ...
        {string_static("distance(1)"), script_num(1)},
        {string_static("distance(-1)"), script_num(1)},
        ...
        {string_static("distance(vec(0,2,0))"), script_num(2)},
        {string_static("distance(vec(1,2,3), vec(1,3,3))"), script_num(1)},
