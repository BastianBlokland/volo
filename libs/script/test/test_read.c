  ...
  it("fails when parsing invalid expressions") {
    static const struct {
      ...
      ScriptDiagKind expected;
        ...
        {string_static("var a = var b = 2"), ScriptDiag_VarDeclareNotAllowed},
        {string_static("var a = while(1) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("var a = for(;;) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("var a = if(1) {}"), ScriptDiag_IfNotAllowed},
        {string_static("var a = return"), ScriptDiag_ReturnNotAllowed},
        {string_static("var a; a = var b = 2"), ScriptDiag_VarDeclareNotAllowed},
        {string_static("var a; a = while(1) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("var a; a = for(;;) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("var a; a = if(1) {}"), ScriptDiag_IfNotAllowed},
        {string_static("var a; a = return"), ScriptDiag_ReturnNotAllowed},
        {string_static("var a; a += var b = 2"), ScriptDiag_VarDeclareNotAllowed},
        {string_static("var a; a += while(1) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("var a; a += for(;;) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("var a; a += if(1) {}"), ScriptDiag_IfNotAllowed},
        {string_static("var a; a += return"), ScriptDiag_ReturnNotAllowed},
        {string_static("$a = var b = 2"), ScriptDiag_VarDeclareNotAllowed},
        {string_static("$a = while(1) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("$a = for(;;) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("$a = if(1) {}"), ScriptDiag_IfNotAllowed},
        {string_static("$a = return"), ScriptDiag_ReturnNotAllowed},
        {string_static("$a += var b = 2"), ScriptDiag_VarDeclareNotAllowed},
        {string_static("$a += while(1) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("$a += for(;;) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("$a += if(1) {}"), ScriptDiag_IfNotAllowed},
        {string_static("$a += return"), ScriptDiag_ReturnNotAllowed},
        {string_static("return var b"), ScriptDiag_VarDeclareNotAllowed},
        {string_static("return while(1) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("return for(;;) {}"), ScriptDiag_LoopNotAllowed},
        {string_static("return return"), ScriptDiag_ReturnNotAllowed},
