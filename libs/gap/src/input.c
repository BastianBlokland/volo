...
static const String g_key_strs[] = {
    ...
    string_static("plus"),       string_static("minus"),       string_static("arrow-up"),
    string_static("arrow-down"), string_static("arrow-right"), string_static("arrow-left"),
    string_static("a"),          string_static("b"),           string_static("c"),
    string_static("d"),          string_static("e"),           string_static("f"),
    string_static("g"),          string_static("h"),           string_static("i"),
    string_static("j"),          string_static("k"),           string_static("l"),
    string_static("m"),          string_static("n"),           string_static("o"),
    string_static("p"),          string_static("q"),           string_static("r"),
    string_static("s"),          string_static("t"),           string_static("u"),
    string_static("v"),          string_static("w"),           string_static("x"),
    string_static("y"),          string_static("z"),           string_static("alpha-0"),
