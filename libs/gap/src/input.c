...
static const String g_keyStrs[] = {
    ...
    string_static("plus"),       string_static("minus"),       string_static("home"),
    string_static("end"),        string_static("page-up"),     string_static("page-down"),
    ...
    string_static("alpha-9"),    string_static("f1"),          string_static("f2"),
    string_static("f3"),         string_static("f4"),          string_static("f5"),
    string_static("f6"),         string_static("f7"),          string_static("f8"),
    string_static("f9"),         string_static("f10"),         string_static("f11"),
    string_static("f12")};
