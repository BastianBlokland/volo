...
u32               ai_tracer_record_count(AiTracerRecord*);
AssetBehaviorType ai_tracer_record_type(AiTracerRecord*, u32 nodeIndex);
String            ai_tracer_record_name(AiTracerRecord*, u32 nodeIndex);
AiResult          ai_tracer_record_result(AiTracerRecord*, u32 nodeIndex);
u8                ai_tracer_record_depth(AiTracerRecord*, u32 nodeIndex);
