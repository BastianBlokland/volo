...
spec(help) {
  ...
  it("can write a help page for an empty app") {
    ...
    check_eq_string(dynstring_view(&string), string_lit("usage: test_cli\n"));
  ...
  it("can write a help page for an app with arguments") {
    ...
    check_eq_string(
        dynstring_view(&string),
        string_lit("usage: test_cli <src-path> [<dst-path>]\n"
                   "\n"
                   "Arguments:\n"
  ...
  it("can write a help page for an app with flags") {
    ...
    check_eq_string(
        dynstring_view(&string),
        string_lit("usage: test_cli [--verbose] [-c <value>]\n"
                   "\n"
                   "Flags:\n"
  ...
  it("can write a help page for an app with an descriptions, arguments and flags") {
    ...
    check_eq_string(
        dynstring_view(&string),
        string_lit("usage: test_cli [--verbose] [-c <value>] <src-path> [<dst-path>]\n"
                   "\n"
                   "My app\n"
                   "\n"
                   "Arguments:\n"
