...
void geo_nav_occupant_clear_all(GeoNavGrid* grid) { grid->occupantCount = 0; }

void geo_nav_occupant_add(GeoNavGrid* grid, const u64 id) {
  ...
  grid->occupants[grid->occupantCount++] = (GeoNavOccupant){
      .id = id,
  };
}
