...
#define dynarray_create_t(_TYPE_, _CAPACITY_)                                                      \
  dynarray_create(bits_align(sizeof(_TYPE_), alignof(_TYPE_)), _CAPACITY_)
...
DynArray dynarray_create(u16 stride, usize capacity);
