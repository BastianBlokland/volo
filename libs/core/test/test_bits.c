...
spec(bits) {
  ...
  it("can check if a 64 bit integer is a power-of-two") {
    ...
    check(bits_ispow2_64(9223372036854775808ull));
  }
  ...
  it("can compute the next power-of-two for a 32 bit integer") {
    ...
    check_eq_int(bits_nextpow2_32(2147483647), 2147483648);
    check_eq_int(bits_nextpow2_32(2147483648), 2147483648);
    // Undefined for val > 2147483648.
  }

  it("can compute the next power-of-two for a 64 bit integer") {
    // Undefined for val,0.
    check_eq_int(bits_nextpow2_64(128), 128);
    check_eq_int(bits_nextpow2_64(255), 256);
    check_eq_int(bits_nextpow2_64(257), 512);
    check_eq_int(bits_nextpow2_64(4096), 4096);
    check_eq_int(bits_nextpow2_64(2147483647), 2147483648);
    check_eq_int(bits_nextpow2_64(68719476735), 68719476736);
    check_eq_int(bits_nextpow2_64(68719476736), 68719476736);
    // check_eq_int(bits_nextpow2_64(9223372036854775807ul), 9223372036854775808ul);
    // check_eq_int(bits_nextpow2_64(9223372036854775808ul), 9223372036854775808ul);
