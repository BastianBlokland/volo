...
f32 math_floor_f32(const f32 val) { return intrinsic_floor_f32(val); }
f64 math_floor_f64(const f64 val) { return intrinsic_floor_f64(val); }

f32 math_ceil_f32(const f32 val) { return intrinsic_ceil_f32(val); }
f64 math_ceil_f64(const f64 val) { return intrinsic_ceil_f64(val); }

f32 math_round_f32(const f32 val) { return intrinsic_round_f32(val); }
f64 math_round_f64(const f64 val) { return intrinsic_round_f64(val); }
