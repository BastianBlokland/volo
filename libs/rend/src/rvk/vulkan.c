...
#define RET_STR(NAME)                                                                              \
  ...
  switch (result) {
    ...
    RET_STR(PIPELINE_COMPILE_REQUIRED);
  default:
