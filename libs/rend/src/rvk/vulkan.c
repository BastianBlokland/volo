...
#define RET_INFO(_NAME_, _SIZE_, _CHANNEL_COUNT_, _FLAGS_)                                         \
  ...
  switch (format) {
    ...
    RET_INFO(BC1_RGB_UNORM_BLOCK, 8, 4, RvkFormat_Block4x4);
    RET_INFO(BC1_RGB_SRGB_BLOCK, 8, 4, RvkFormat_Block4x4 | RvkFormat_Srgb);
    ...
    RET_INFO(BC4_UNORM_BLOCK, 8, 4, RvkFormat_Block4x4);
    RET_INFO(BC4_SNORM_BLOCK, 8, 4, RvkFormat_Block4x4);
    RET_INFO(BC5_UNORM_BLOCK, 16, 4, RvkFormat_Block4x4);
    RET_INFO(BC5_SNORM_BLOCK, 16, 4, RvkFormat_Block4x4);
