...
#define RET_INFO(_NAME_, _SIZE_, _CHANNEL_COUNT_, _FLAGS_)                                         \
  ...
  switch (format) {
    ...
    RET_INFO(R8G8B8A8_UNORM, 4, 4, 0);
    RET_INFO(R8G8B8A8_SNORM, 4, 4, 0);
    RET_INFO(R8G8B8A8_USCALED, 4, 4, 0);
    RET_INFO(R8G8B8A8_SSCALED, 4, 4, 0);
    RET_INFO(R8G8B8A8_UINT, 4, 4, 0);
    RET_INFO(R8G8B8A8_SINT, 4, 4, 0);
    RET_INFO(R8G8B8A8_SRGB, 4, 4, RvkFormat_Srgb);
    RET_INFO(B8G8R8A8_UNORM, 4, 4, 0);
    RET_INFO(B8G8R8A8_SNORM, 4, 4, 0);
    RET_INFO(B8G8R8A8_USCALED, 4, 4, 0);
    RET_INFO(B8G8R8A8_SSCALED, 4, 4, 0);
    RET_INFO(B8G8R8A8_UINT, 4, 4, 0);
    RET_INFO(B8G8R8A8_SINT, 4, 4, 0);
    RET_INFO(B8G8R8A8_SRGB, 4, 4, RvkFormat_Srgb);
    ...
    RET_INFO(BC1_RGB_UNORM_BLOCK, 8, 4, 0);
    RET_INFO(BC1_RGB_SRGB_BLOCK, 8, 4, RvkFormat_Srgb);
    RET_INFO(BC1_RGBA_UNORM_BLOCK, 8, 4, 0);
    RET_INFO(BC1_RGBA_SRGB_BLOCK, 8, 4, RvkFormat_Srgb);
    RET_INFO(BC2_UNORM_BLOCK, 16, 4, 0);
    RET_INFO(BC2_SRGB_BLOCK, 16, 4, RvkFormat_Srgb);
    RET_INFO(BC3_UNORM_BLOCK, 16, 4, 0);
    RET_INFO(BC3_SRGB_BLOCK, 16, 4, RvkFormat_Srgb);
    RET_INFO(BC4_UNORM_BLOCK, 8, 4, 0);
    RET_INFO(BC4_SNORM_BLOCK, 8, 4, 0);
    RET_INFO(BC5_UNORM_BLOCK, 16, 4, 0);
    RET_INFO(BC5_SNORM_BLOCK, 16, 4, 0);
    RET_INFO(BC6H_UFLOAT_BLOCK, 16, 4, 0);
    RET_INFO(BC6H_SFLOAT_BLOCK, 16, 4, 0);
    RET_INFO(BC7_UNORM_BLOCK, 16, 4, 0);
    RET_INFO(BC7_SRGB_BLOCK, 16, 4, RvkFormat_Srgb);
    RET_INFO(ETC2_R8G8B8_UNORM_BLOCK, 8, 3, 0);
    RET_INFO(ETC2_R8G8B8_SRGB_BLOCK, 8, 3, RvkFormat_Srgb);
    RET_INFO(ETC2_R8G8B8A1_UNORM_BLOCK, 8, 4, 0);
    RET_INFO(ETC2_R8G8B8A1_SRGB_BLOCK, 8, 4, RvkFormat_Srgb);
    RET_INFO(ETC2_R8G8B8A8_UNORM_BLOCK, 16, 4, 0);
    RET_INFO(ETC2_R8G8B8A8_SRGB_BLOCK, 16, 4, RvkFormat_Srgb);
    RET_INFO(EAC_R11_UNORM_BLOCK, 8, 1, 0);
    RET_INFO(EAC_R11_SNORM_BLOCK, 8, 1, 0);
    RET_INFO(EAC_R11G11_UNORM_BLOCK, 16, 2, 0);
    RET_INFO(EAC_R11G11_SNORM_BLOCK, 16, 2, 0);
