...
static RvkBcColor565 bc_color_to_565(const RvkBcColor8888* c) {
 ...
 */
static void bc_color_quantize_565(RvkBcColor8888* c) {
  c->r = (c->r & 0b11111000) | (c->r >> 5);
  c->g = (c->g & 0b11111100) | (c->g >> 6);
  c->b = (c->b & 0b11111000) | (c->b >> 5);
}

static u32 bc_color_luminance(const RvkBcColor8888* c) { return c->r + c->g * 2 + c->b; }

static u32 bc_color_distance_sqr(const RvkBcColor8888* a, const RvkBcColor8888* b) {
...
static void bc_color_swap(RvkBcColor8888* a, RvkBcColor8888* b) {
  RvkBcColor8888 tmp = *a;
  *a                 = *b;
  *b                 = tmp;
}
...
static void bc_block_implicit_colors(
    const RvkBcColor8888* min,
    const RvkBcColor8888* max,
    RvkBcColor8888*       outA,
    RvkBcColor8888*       outB) {
...
static void bc_block_bounds(const RvkBc0Block* b, RvkBcColor8888* outMin, RvkBcColor8888* outMax) {
  u32 lumMin = u32_max, lumMax = 0;
  array_for_t(b->colors, RvkBcColor8888, c) {
