...
static const RendResGlobalDef g_rendResGlobal[] = {
  ...
  { .repoId = RvkRepositoryId_BloomDownGraphic,             .assetId = string_static("graphics/builtin/bloom_down.graphic") },
  { .repoId = RvkRepositoryId_BloomUpGraphic,               .assetId = string_static("graphics/builtin/bloom_up.graphic") },
  { .repoId = RvkRepositoryId_DebugImageViewerArrayGraphic, .assetId = string_static("graphics/dev/image_viewer_array.graphic") },
