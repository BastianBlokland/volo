...
* Install `XCB` + `xkb`, `xkbcommon`, `xkbcommon-x11`, `xfixes` and `render` extensions
  (debian: `apt install libxcb1-dev libxcb-xkb-dev libxkbcommon-dev libxkbcommon-x11-dev libxcb-xfixes0-dev libxcb-render0-dev`).
